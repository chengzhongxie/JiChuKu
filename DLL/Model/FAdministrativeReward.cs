...
namespace DAL.Model
{
    ...
    /// 行政奖励F集合
    /// </summary>
    public class FAdministrativeReward : FatherClass
    {
        /// <summary>
        /// 荣誉称号/获奖名称
        /// </summary>
    ...
    public class FAdministrativeRewardConfiguration : IEntityTypeConfiguration<FAdministrativeReward>
    {
        public void Configure(EntityTypeBuilder<FAdministrativeReward> builder)
        {
            ...
            builder.HasOne(x => x.FLegalPerson).WithMany(x => x.FAdministrativeRewards).HasForeignKey(x => x.FLegalPersonID).OnDelete(DeleteBehavior.Cascade);
        }
    }
}
