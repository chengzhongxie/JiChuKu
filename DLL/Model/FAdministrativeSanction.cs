...
namespace DAL.Model
{
    ...
    /// 行政处罚F集合
    /// </summary>
    public class FAdministrativeSanction : FatherClass
    {
        /// <summary>
        /// 行政处罚决定书文号
        /// </summary>
    ...
    public class FAdministrativeSanctionConfiguration : IEntityTypeConfiguration<FAdministrativeSanction>
    {
        public void Configure(EntityTypeBuilder<FAdministrativeSanction> builder)
        {
            ...
            builder.HasOne(x => x.FLegalPerson).WithMany(x => x.FAdministrativeSanctions).HasForeignKey(x => x.FLegalPersonID).OnDelete(DeleteBehavior.Cascade);
        }
    }
}
